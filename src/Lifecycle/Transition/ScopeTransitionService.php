...
namespace Maatify\Slug\Lifecycle\Transition;
...
final readonly class ScopeTransitionService
{
    ...
    public function transitionScope(TransitionScopeCommand $command): ScopeTransitionResultDTO
    {
        ...
        return $this->transactions->run(function () use ($command, $targetCandidates, $fingerprint): ScopeTransitionResultDTO {
            ...
            /** @var list<array{is_source: bool, scope: \Maatify\Slug\Scope\DTO\ScopeDTO, entity: \Maatify\Slug\Registry\Value\EntityReference, existing: ?RegistryBindingRecord}> $bindingPlan */
            $bindingPlan = [
            ...
            /** @var list<\Maatify\Slug\Lifecycle\History\HistoryEventDTO> $sourceHistory */
            $sourceHistory = $this->appendEvents($sourceBefore->id, $sourceBefore->state->historySequence, $sourceEvents);
            /** @var list<\Maatify\Slug\Lifecycle\History\HistoryEventDTO> $targetHistory */
    ...
    private function claimEvent(
        ...
        \Maatify\Slug\Registry\Value\EntityReference $relatedEntity,
     ...
     * @return list<\Maatify\Slug\Lifecycle\History\HistoryEventDTO>
     */

...
/** Composite lifecycle adapter exposing the complete persisted lifecycle boundary. */
final readonly class PersistedSlugLifecycleService implements SlugLifecycleServiceInterface
{
    /** Combines legacy lifecycle, scope-transition, and adoption implementations. */
    ...
    /** Delegates exact assignment to the WU-05 lifecycle implementation. */
    ...
    /** Delegates generated assignment to the WU-05 lifecycle implementation. */
    ...
    /** Delegates exact change to the WU-05 lifecycle implementation. */
    ...
    /** Delegates generated change to the WU-05 lifecycle implementation. */
    ...
    /** Delegates historical restoration to the WU-05 lifecycle implementation. */
    ...
    /** Delegates binding deactivation to the WU-05 lifecycle implementation. */
    ...
    /** Delegates binding reactivation to the WU-05 lifecycle implementation. */
    ...
    /** Delegates single-claim release to the WU-05 lifecycle implementation. */
    ...
    /** Delegates all-ownership release to the WU-05 lifecycle implementation. */
    ...
    /** Delegates scope transition to the WU-06 transition service. */
    ...
    /** Delegates atomic transfer to the WU-05 lifecycle implementation. */
    ...
    /** Delegates alias creation to the WU-05 lifecycle implementation. */
    public function addAlias(AddAliasCommand $command): SlugMutationResultDTO
    {
        return $this->legacyLifecycle->addAlias($command);
    }
    /** Delegates alias retirement to the WU-05 lifecycle implementation. */
    ...
    /** Delegates alias reactivation to the WU-05 lifecycle implementation. */
    ...
    /** Delegates alias promotion to the WU-05 lifecycle implementation. */
    ...
    /** Delegates current-claim adoption to the WU-06 adoption service. */
    public function adoptCurrent(AdoptCurrentCommand $command): AdoptionResultDTO
    {
        return $this->adoption->adoptCurrent($command);
    }
    /** Delegates historical-claim adoption to the WU-06 adoption service. */
    ...
    /** Delegates alias-claim adoption to the WU-06 adoption service. */
    public function adoptAlias(AdoptAliasCommand $command): AdoptionResultDTO
    {
        return $this->adoption->adoptAlias($command);
    }
    /** Delegates permanent binding purge to the WU-05 lifecycle implementation. */

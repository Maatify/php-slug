...
namespace Maatify\Slug\Query\Availability;
...
final readonly class SlugAvailabilityChecker
{
    ...
    public function check(AvailabilityCriteria $criteria): SlugAvailabilityDTO
    {
        ...
        try {
            $slug = $profile->canonicalizeClaim($criteria->candidate)->slug;
    ...
    private function owner(RegistryClaimRecord $claim): \Maatify\Slug\Registry\DTO\BindingDTO
    {
        ...
        $identity = new BindingIdentityDTO(
            ...
            new \Maatify\Slug\Registry\Value\EntityReference($claim->entityType, $claim->entityKey),
        );

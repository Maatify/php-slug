...
namespace Maatify\Slug\Persistence\PDO\Query;
...
use Maatify\Slug\Registry\DTO\BindingStateDTO;
...
final readonly class PdoSlugManagementQueryRepository
{
    ...
    private function claimFromRow(array $row): RegistryClaimDTO
    {
        ...
        $identity = new BindingIdentityDTO(
            new \Maatify\Slug\Scope\DTO\ScopeProfileRequestDTO($scope, $profileKey),
    ...
    private function bindingFromRow(array $row): BindingDTO
    {
        ...
        $identity = new BindingIdentityDTO(new \Maatify\Slug\Scope\DTO\ScopeProfileRequestDTO($scope, $profileKey), $entity);

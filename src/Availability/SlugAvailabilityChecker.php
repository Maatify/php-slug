...
namespace Maatify\Slug\Availability;
...
final readonly class SlugAvailabilityChecker
{
    ...
    private function owner(RegistryClaimRecord $claim): \Maatify\Slug\DTO\BindingDTO
    {
        ...
        $identity = new BindingIdentityDTO(
            ...
            new \Maatify\Slug\Identity\EntityReference($claim->entityType, $claim->entityKey),
        );

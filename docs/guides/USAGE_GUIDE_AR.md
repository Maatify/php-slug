...
الحزمة Development / Unpublished. لا توجد حاليًا قناة توزيع عامة أو أمر تثبيت عام صالح؛ إعداد التطوير موثق في CONTRIBUTING.md. لا تعرض composer require maatify/php-slug على أنه طريقة استهلاك حالية.
